...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets sw3]
...
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports sda_0]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports scl_0]
