...
--Date        : Thu Dec 05 08:29:29 2019
--Host        : DESKTOP-A5HR7K6 running 64-bit major release  (build 9200)
--Command     : generate_target SSD1306_example_bd.bd
--Design      : SSD1306_example_bd
...
entity SSD1306_example_bd is
  ...
  attribute core_generation_info of SSD1306_example_bd : entity is "SSD1306_example_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SSD1306_example_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,da_ps7_cnt=1,synth_mode=Global}";
  attribute hw_handoff : string;
  attribute hw_handoff of SSD1306_example_bd : entity is "SSD1306_example_bd.hwdef";
end SSD1306_example_bd;

architecture STRUCTURE of SSD1306_example_bd is
  component SSD1306_example_bd_processing_system7_0_0 is
  port (
  ...
  end component SSD1306_example_bd_processing_system7_0_0;
...
processing_system7_0: component SSD1306_example_bd_processing_system7_0_0
     port map (
