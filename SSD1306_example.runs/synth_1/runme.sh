...
HD_PWD='C:/Users/0036472890/workspace/SSD1306_example/SSD1306_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSD1306_example_TopWrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SSD1306_example_TopWrapper.tcl
