...
HD_PWD='C:/Users/0036472890/workspace/SSD1306_example/SSD1306_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SSD1306_example_TopWrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SSD1306_example_TopWrapper.tcl -notrace
